        ...
        if (controller.isEmpty) {
          return const Center(
            child: Column(
              ...
              children: [
                Icon(Icons.history, size: 64, color: AppColors.textDisable),
                SizedBox(height: 16),
                Text(
                  '분석 기록이 없습니다',
                  style: TextStyle(fontSize: 16, color: AppColors.textDisable),
                ),
              ],
            ),
          );
  ...
  Widget _buildErrorBody() {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          const Icon(Icons.error_outline, size: 64, color: AppColors.textDisable),
